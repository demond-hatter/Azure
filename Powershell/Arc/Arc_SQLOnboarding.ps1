...
.EXAMPLE
    ...
    .\Arc_SqlOnboarding.ps1 -subscriptionId "797987" -resourceGroup "myRGroup" -tenantId "7097r598724e098" -location "eastus2" -licenseType "Paid" -csvFilePath "C:\Temp\ArcMachines.csv" -logFilePath "C:\Temp\ArcOnboardingLog.txt" -tags "DataCenter=DC1,Environment=Test"
.EXAMPLE
    This example illustrates using service principal to authenticate and calling all required parameters

    .\Arc_SqlOnboarding.ps1 -servicePrincipalClientId "98080..." -servicePrincipalSecret "7707879867986" -subscriptionId "797987" -resourceGroup "myRGroup" -tenantId "7097r598724e098" -location "eastus2" -tags "APMID=999999,DataCenter=CCC"
#>
[CmdletBinding()]
Param(
